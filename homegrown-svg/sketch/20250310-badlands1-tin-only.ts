...
const coordsFile = readFileSync('./tin.time100.hd5.coords.json').toString()
const cellsFile = readFileSync('./tin.time100.hd5.cells.json').toString()
...
// 36672 coordinates
// 36672/191 = 192
// column major order going from SW corner to NE
// I think this actually corresponds to SVG fairly well, it goes from (yMax, xMin) to (yMin, xMax) in column-major order (i.e. ascending y is first)
...
// TODO: maybe this can be initialized better for memory allocations??? Does it matter???

///// attempt 1 did not work
// const ts: Triangle3[] = []
// for (let i = 0; i < coords.length; i += 3) {
//   if (i + 2 < coords.length) {
//     const v1 = vec3(coords[i][0], coords[i][1], coords[i][2])
//     const v2 = vec3(coords[i+1][0], coords[i+1][1], coords[i+1][2])
//     const v3 = vec3(coords[i+1][0], coords[i+2][1], coords[i+1][2])
//     ts.push([v1, v2, v3])
//   }
// }
...
for (let i = 0; i < cells.length; i += 1) {
  ...
  ///// longhand
  // const v1Coords = coords[v1Index]
  // const v1 = vec3(v1Coords[0], v1Coords[1], v1Coords[2])

  ///// shorthand
  ///// 🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽🔽
  ///// 🎉🎉🎉 HOLY FUCKING SHIT!!!!!! MINUS 1!!!!!!!! 🎉🎉🎉🎉🎉
  ///// 🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼

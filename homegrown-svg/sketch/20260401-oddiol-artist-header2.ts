...
// const config = { width: 1330, height: 590, scale: 1, loopCount: 1 };
...
const CLUSTER_RING_START_RADIUS = BASE_DIM * 0.001;
const CLUSTER_RING_SPACING = BASE_DIM * 0.03;
const CLUSTER_RING_MAX_RADIUS = BASE_DIM * 0.4;
const RING_COUNT = Math.max(
  1,
  Math.floor(
    (CLUSTER_RING_MAX_RADIUS - CLUSTER_RING_START_RADIUS) /
      CLUSTER_RING_SPACING,
  ) + 1,
);

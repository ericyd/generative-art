...
// void mainImage( out vec4 FragColor, in vec2 doNotUse) {
    ...
    float toCenter = 1.0 - length(vec2(0.55, 0.45) - p);
    tot *= 2.75 * pow(toCenter, 1.35);
